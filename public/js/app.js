...
var commandsApp = new Vue({
  ...
  methods: {
    setSelectedCommand: function setSelectedCommand() {
      if (lastCommand) {
  ...
  computed: {
    currentCommandObj: function currentCommandObj() {
      if (!this.selectedCommand || !this.commands[this.selectedCommand]) {
        return null;
      }
    ...
    hasCommandParams: function hasCommandParams() {
      if (!this.currentCommandObj || !this.currentCommandObj.commands_params) {
        return false;
      }
    ...
    getDocumentationUrl: function getDocumentationUrl() {
      var url = 'https://docs.factom.com/api';
    ...
    hasResultsJson: function hasResultsJson() {
      return Boolean(resultsJson);
    },

    getResultsJson: function getResultsJson() {
